...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            [datetime(2023, 1, 1), datetime(2023, 1, 2), datetime(2023, 1, 3), datetime(2023, 1, 4), datetime(2023, 1, 5)],
            [datetime(2023, 1, 1), datetime(2023, 1, 2), datetime(2023, 1, 3), datetime(2023, 1, 4), datetime(2023, 1, 5)],
        ),
        ...
        (
            [datetime(2023, 2, 1), datetime(2023, 1, 2), datetime(2023, 1, 3), datetime(2023, 1, 4), datetime(2023, 1, 5)],
            [datetime(2023, 1, 1), datetime(2023, 1, 2), datetime(2023, 1, 3), datetime(2023, 1, 4), datetime(2023, 1, 5)],
        ),
        # Test a series that crosses a month boundary
        (
            [datetime(2023, 1, 29), datetime(2023, 1, 30), datetime(2023, 1, 31), datetime(2023, 2, 1), datetime(2023, 2, 2)],
            [datetime(2023, 1, 29), datetime(2023, 1, 30), datetime(2023, 1, 31), datetime(2023, 2, 1), datetime(2023, 2, 2)],
        ),
    ]
)
